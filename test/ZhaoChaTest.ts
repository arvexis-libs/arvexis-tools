...
import { Entry } from '../Scripts/UI/Entry/Entry';
import { ZhaoChaConfig, ZhaoChaUIID } from '../Scripts/Common/ZhaoChaConfig';
import { ZhaoChaEvent } from '../Scripts/Common/ZhaoChaEvent';
...
@ccclass('ZhaoChaTest')
export class ZhaoChaTest extends Root {
    start() {
